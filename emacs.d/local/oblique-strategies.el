...
that they will improve his virility shovels them straight into his lap)"
    "Use an old idea"
...
(defun oblique-strategies ()
  ...
  (message "%s"
           (nth
            (random (length *oblique-strategy-list*))
            *oblique-strategy-list*)))

(provide 'oblique-strategies)
;;; oblique-stategies.el ends here
